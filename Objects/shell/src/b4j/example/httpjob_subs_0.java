...
try {
		Debug.PushSubsStack("AddScheme (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,52);
...
try {
		Debug.PushSubsStack("Complete (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,315);
...
try {
		Debug.PushSubsStack("Delete (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,261);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","93080197",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("Delete2 (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,272);
...
try {
		Debug.PushSubsStack("Download (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,219);
...
try {
		Debug.PushSubsStack("Download2 (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,235);
...
try {
		Debug.PushSubsStack("escapeLink (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,246);
...
try {
		Debug.PushSubsStack("GetBitmap (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,322);
...
RemoteObject _b = RemoteObject.declareNull("anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper");
 BA.debugLineNum = 322;BA.debugLine="Public Sub GetBitmap As Image";
Debug.JustUpdateDeviceLine();
 BA.debugLineNum = 323;BA.debugLine="Dim b As Image";
Debug.JustUpdateDeviceLine();
_b = RemoteObject.createNew ("anywheresoftware.b4j.objects.ImageViewWrapper.ImageWrapper");Debug.locals.put("b", _b);
 BA.debugLineNum = 324;BA.debugLine="b = fx.LoadImage(HttpUtils2Service.TempFolder, ta";
Debug.JustUpdateDeviceLine();
_b = __ref.getField(false,"_fx" /*RemoteObject*/ ).runMethod(false,"LoadImage",(Object)(httpjob._httputils2service._tempfolder /*RemoteObject*/ ),(Object)(__ref.getField(true,"_taskid" /*RemoteObject*/ )));Debug.locals.put("b", _b);
 BA.debugLineNum = 325;BA.debugLine="Return b";
Debug.JustUpdateDeviceLine();
if (true) return _b;
...
try {
		Debug.PushSubsStack("GetInputStream (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,347);
...
try {
		Debug.PushSubsStack("GetRequest (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,310);
...
try {
		Debug.PushSubsStack("GetString (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,291);
...
try {
		Debug.PushSubsStack("GetString2 (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,296);
...
try {
		Debug.PushSubsStack("Head (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,119);
...
try {
		Debug.PushSubsStack("MultipartStartSection (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,179);
...
try {
		Debug.PushSubsStack("PatchBytes (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,97);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","92555916",(RemoteObject.concat(RemoteObject.createImmutable("Invalid link: "),httpjob.__c.runMethod(true,"SmartStringFormatter",(Object)(BA.ObjectToString("")),(Object)((_link))),RemoteObject.createImmutable(""))),0);
...
try {
		Debug.PushSubsStack("PatchString (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,92);
...
try {
		Debug.PushSubsStack("PostBytes (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,63);
...
try {
		Debug.PushSubsStack("PostFile (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,190);
...
Debug.JustUpdateDeviceLine();
httpjob.__c.runVoidMethod ("LogImpl","92818056",RemoteObject.createImmutable("Cannot send files from the assets folder."),0);
...
try {
		Debug.PushSubsStack("PostMultipart (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,133);
...
try {
		Debug.PushSubsStack("PostString (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,58);
...
try {
		Debug.PushSubsStack("PutBytes (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,80);
...
try {
		Debug.PushSubsStack("PutString (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,75);
...
try {
		Debug.PushSubsStack("Release (httpjob) ","httpjob",2,__ref.getField(false, "ba"),__ref,284);
